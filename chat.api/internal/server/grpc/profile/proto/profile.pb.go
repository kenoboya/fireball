...
func (x *Response) Reset() {
	*x = Response{}
	mi := &file_internal_server_grpc_profile_proto_profile_proto_msgTypes[0]
...
func (*Response) Descriptor() ([]byte, []int) {
	return file_internal_server_grpc_profile_proto_profile_proto_rawDescGZIP(), []int{0}
}
...
func (x *UserRequest) Reset() {
	*x = UserRequest{}
	mi := &file_internal_server_grpc_profile_proto_profile_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserRequest) Descriptor() ([]byte, []int) {
	return file_internal_server_grpc_profile_proto_profile_proto_rawDescGZIP(), []int{1}
}
...
func (x *UsersRequest) Reset() {
	*x = UsersRequest{}
	mi := &file_internal_server_grpc_profile_proto_profile_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UsersRequest) Descriptor() ([]byte, []int) {
	return file_internal_server_grpc_profile_proto_profile_proto_rawDescGZIP(), []int{2}
}
...
func (x *User) Reset() {
	*x = User{}
	mi := &file_internal_server_grpc_profile_proto_profile_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*User) Descriptor() ([]byte, []int) {
	return file_internal_server_grpc_profile_proto_profile_proto_rawDescGZIP(), []int{3}
}
...
func (x *UsersProfileResponse) Reset() {
	*x = UsersProfileResponse{}
	mi := &file_internal_server_grpc_profile_proto_profile_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UsersProfileResponse) Descriptor() ([]byte, []int) {
	return file_internal_server_grpc_profile_proto_profile_proto_rawDescGZIP(), []int{4}
}
...
func (x *UserBriefInfoResponse) Reset() {
	*x = UserBriefInfoResponse{}
	mi := &file_internal_server_grpc_profile_proto_profile_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserBriefInfoResponse) Descriptor() ([]byte, []int) {
	return file_internal_server_grpc_profile_proto_profile_proto_rawDescGZIP(), []int{5}
}
...
func (x *UsersBriefInfoResponse) Reset() {
	*x = UsersBriefInfoResponse{}
	mi := &file_internal_server_grpc_profile_proto_profile_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UsersBriefInfoResponse) Descriptor() ([]byte, []int) {
	return file_internal_server_grpc_profile_proto_profile_proto_rawDescGZIP(), []int{6}
}
...
var File_internal_server_grpc_profile_proto_profile_proto protoreflect.FileDescriptor

const file_internal_server_grpc_profile_proto_profile_proto_rawDesc = "" +
	"\n" +
	"0internal/server/grpc/profile/proto/profile.proto\x12\x05proto\">\n" +
	"\bResponse\x12\x18\n" +
...
var (
	file_internal_server_grpc_profile_proto_profile_proto_rawDescOnce sync.Once
	file_internal_server_grpc_profile_proto_profile_proto_rawDescData []byte
)

func file_internal_server_grpc_profile_proto_profile_proto_rawDescGZIP() []byte {
	file_internal_server_grpc_profile_proto_profile_proto_rawDescOnce.Do(func() {
		file_internal_server_grpc_profile_proto_profile_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_internal_server_grpc_profile_proto_profile_proto_rawDesc), len(file_internal_server_grpc_profile_proto_profile_proto_rawDesc)))
	})
	return file_internal_server_grpc_profile_proto_profile_proto_rawDescData
}

var file_internal_server_grpc_profile_proto_profile_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_internal_server_grpc_profile_proto_profile_proto_goTypes = []any{
...
var file_internal_server_grpc_profile_proto_profile_proto_depIdxs = []int32{
...
func init() { file_internal_server_grpc_profile_proto_profile_proto_init() }
func file_internal_server_grpc_profile_proto_profile_proto_init() {
	if File_internal_server_grpc_profile_proto_profile_proto != nil {
		return
	}
	file_internal_server_grpc_profile_proto_profile_proto_msgTypes[3].OneofWrappers = []any{}
	file_internal_server_grpc_profile_proto_profile_proto_msgTypes[5].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_internal_server_grpc_profile_proto_profile_proto_rawDesc), len(file_internal_server_grpc_profile_proto_profile_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_internal_server_grpc_profile_proto_profile_proto_goTypes,
		DependencyIndexes: file_internal_server_grpc_profile_proto_profile_proto_depIdxs,
		MessageInfos:      file_internal_server_grpc_profile_proto_profile_proto_msgTypes,
	}.Build()
	File_internal_server_grpc_profile_proto_profile_proto = out.File
	file_internal_server_grpc_profile_proto_profile_proto_goTypes = nil
	file_internal_server_grpc_profile_proto_profile_proto_depIdxs = nil
}
